...
Controls: 
WASDQE: Movement
F:      Toggle orthogonic/perspective view
*/
...
namespace
{
    const char* const WINDOW_TITLE = "Austin Little | Module Four Milestone"; // Macro for window title
...
void URender()
{
    ...
    //FIXME: Sets up projections
    //glm::mat4 projection = glm::ortho(0.0f, (GLfloat)WINDOW_WIDTH, (GLfloat)WINDOW_HEIGHT, 0.0f, 0.1f, 100.0f);
...
//Keyboard input for perspective / ortho view
