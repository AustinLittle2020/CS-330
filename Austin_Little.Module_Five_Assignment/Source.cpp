...
* F           : Toggle ortho / perspective view
*/
...
//FIXME: Global Variables (2 lines)
...
namespace
{
    const char* const WINDOW_TITLE = "Austin Little | Final Project"; // Macro for window title
...
int main(int argc, char* argv[])
{
    ...
    const char* texFilename = "orange-brick.jpg";
...
//FIXME: Keyboard input for perspective / ortho view (whole function)
